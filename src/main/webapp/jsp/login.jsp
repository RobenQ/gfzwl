...
<head>
	<meta charset="UTF-8">
	<title>管理员登陆</title>
	<script src="/gfzwl/js/jquery.min.js"></script>
...
<link rel="stylesheet"
	href="/gfzwl/css/login.css" type="text/css">
<link rel="stylesheet"
	href="/gfzwl/admin/bootstrap.css"
	type="text/css">
