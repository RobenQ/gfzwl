...
function download2(btn){
	...
	http.open("GET", "/gfzwl/admin/deletefile4_1_1a?path="+path+"&name="+name+"&type="+type, true);
//	http.setRequestHeader("Content-type", "application/x-www-form-urlencoded;");
	http.send();
	http.onreadystatechange = function() {
		if(http.readyState == 4 && http.status == 200) {
			window.location.href="/gfzwl/admin/deletefile4_1_1a?path="+path+"&name="+name+"&type="+type;
		}
	}
}